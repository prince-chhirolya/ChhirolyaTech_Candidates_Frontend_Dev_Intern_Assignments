            ...
            <li className="mb-8 md:w-auto md:mb-0">
              ...
              <ul>
                <li className="flex mb-3 text-xs md:text-sm md:mb-3">
                  <a
                    className="font-normal text-neutral-400 hover:text-white"
                    href="/guides/data-labeling-annotation-guide"
                  >
                    Data Labeling
                  </a>
                </li>
                <li className="flex mb-3 text-xs md:text-sm md:mb-3">
                  <a
                    className="font-normal text-neutral-400 hover:text-white"
                    href="/guides/model-training-building"
                  >
                    ML Model Training
                  </a>
                </li>
                <li className="flex mb-3 text-xs md:text-sm md:mb-3">
                  <a
                    className="font-normal text-neutral-400 hover:text-white"
                    href="/guides/diffusion-models-guide"
                  >
                    Diffusion Models
                  </a>
                </li>
                ...
                <li className="flex mb-3 text-xs md:text-sm md:mb-3">
                  <a
                    className="font-normal text-neutral-400 hover:text-white"
                    href="/guides/large-language-models"
                  >
