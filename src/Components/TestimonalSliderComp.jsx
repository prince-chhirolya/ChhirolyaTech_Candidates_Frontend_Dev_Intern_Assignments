        ...
        <div className='relative mx-8'>
            ...
            <div className='absolute inset-12'>
                <div className='flex flex-col justify-center items-center gap-4'>
                    <h1 className='text-2xl font-semibold text-heroBgColor'>Get started for free</h1>
                    <p className='w-96 text-center mx-5 text-sm px-8 font-medium leading-6 md:p-0'>Play around with GitBook and set up your docs for free.  Add your team and pay when you’re ready.</p>
                    <div className="flex flex-col justify-center gap-4 lg:flex-row text-heroBgColor w-80 md:w-96">
