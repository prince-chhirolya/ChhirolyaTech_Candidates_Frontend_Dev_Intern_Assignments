      ...
      <div className="flex flex-col  items-center text-center text-white">
        ...
        <div className="textContainer flex flex-col gap-y-2 mt-8">
          ...
          <div className="flex justify-center gap-x-3">
            ...
            <button className="bg-amber-200 px-4 py-1 rounded-lg font-medium text-black tracking-wide hover:bg-cyan-700 hover:hover:text-white transition duration-300 ease-in-out">
