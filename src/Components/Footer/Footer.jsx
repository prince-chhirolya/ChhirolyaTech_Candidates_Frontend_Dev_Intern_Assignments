        ...
        <div className='bg-heroBgColor  text-white'>
            <div className='flex flex-col justify-between w-full gap-y-20 mx-auto' style={{ maxWidth: "1024px" }}>
                ...
                <div className='flex flex-col md:flex-row items-center justify-between p-4'>
                    <div className='flex-shrink-0 mb-4 md:mb-0 opacity-50'>

                        <img src="/aicpa.svg" alt="" />
                    ...
                    <div className='flex flex-col gap-y-5 justify-center items-center'>
                        ...
                        <span className='font-thin opacity-50' style={{ wordSpacing: "0.30rem",fontSize:"0.60rem",lineHeight:'1rem' }}>© 2024 Copyright GitBook INC. 440 N Barranca Ave #7171, Covina, CA 91723, USA. EIN: 320502699</span>
                    </div>
