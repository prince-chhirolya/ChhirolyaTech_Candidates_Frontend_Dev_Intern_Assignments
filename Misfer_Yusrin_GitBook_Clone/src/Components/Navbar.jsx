    ...
    const navList = (
        <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
            ...
            >
                ...
                <a href="#" className="flex items-center text-bgAmberColor">
                    ...
                    <div className="flex items-center justify-between text-blue-gray-900 mx-5 py-3 lg:py-0">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-x-2">
                                ...
                                <button
                                    className="hidden lg:inline-block bg-bgAmberColor px-4 py-1 rounded-lg font-medium text-black tracking-wide hover:bg-btnHoverColor hover:hover:text-white transition duration-300 ease-in-out"
                                >
